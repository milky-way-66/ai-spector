...
Generated by `/summary` into this folder only. Do not edit by hand — re-run after SRS or basic design changes.
...
| `detail-design.md` | `docs/detail-design/` | downstream review / impact after detail design edits |
...
Placeholder text (`not yet run`, `No entries yet`) means `/summary` must be run before generation commands will proceed.
