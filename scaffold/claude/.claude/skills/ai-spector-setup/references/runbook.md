...
- Copies all agent skills to `.claude/skills/`
...
2. **Settings → Rules → Agent Skills** — enable **all** folders under `.claude/skills/`.
3. **Reload MCP** if `.claude/mcp.json` is present.
