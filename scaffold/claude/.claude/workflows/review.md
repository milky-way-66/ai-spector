...
**Workflow trigger:** activate **`ai-spector-review`** immediately.

Formal **document sign-off** (`review_approve`) — not comment threads, extracted specs, or task plans.

Read `.claude/skills/ai-spector-review/skill.md` and `references/runbook.md` before any tool call.
...
|----------|-------------|
| Resolve comment C-012 | `workflow: resolve-comments` |
