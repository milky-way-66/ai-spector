...
Parse `regenerate` / `review` buckets with `projectionPath`. If `noTraceabilityImpact: true`, tell the user no doc traceability impact was found. Do not invent regen lists — use CLI output only.
