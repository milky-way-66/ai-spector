# Task: link-graph — semantic meaning edges (agent + CLI)
...
See [cli-failures.md](../../ai-spector/references/cli-failures.md). If merge rejects an edge, fix the patch ids/types and re-run merge.
