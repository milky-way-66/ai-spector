...
This project is indexed by GitNexus as **ai-spector** (7512 symbols, 10703 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
