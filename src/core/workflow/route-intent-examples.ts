...
export const WORKFLOW_ROUTE_EXAMPLES: WorkflowRouteExample[] = [
  ...
  { say: "backfill SRS from basic design", skill: "ai-spector-generate-srs" },
  { say: "generate SRS from basic design", skill: "ai-spector-generate-srs" },
  { say: "expand SRS to full", skill: "ai-spector-generate-srs" },
  ...
  { say: "migrate my existing docs to Writer", skill: "ai-spector" },
  { say: "align legacy SRS folders", skill: "ai-spector" },
